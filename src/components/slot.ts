...
export class Slot {
  ...
  static CostsForLevels(level: number): number[] {
    const costs = [
      ...
      [8.9, 3, 1.1, 1.1, 1, 0.5, 1, 1.1, 1.1, 3, 8.9], // 10 lines slot costs !! seems it should be 1.4 instead
      [8.4, 3, 1.9, 1.3, 1, 0.7, 0.7, 1, 1.3, 1.9, 3, 8.4], // 11 lines slot costs
      [10, 3, 1.6, 1.4, 0.5, 0.5, 0.5, 0.5, 0.5, 1.4, 1.6, 3, 10], // 12 lines slot costs
